...
<h3></h3>
	...
	<div id="contents" style=" padding:20px; height:0px; width:550px; font-size:10px; background-color:#9DC5F1; margin-bottom:0px;">
			...
			<table style='margin-bottom:40px;'>
				<tr>
					...
					if(mysql_num_rows($query2)>=1){
						...
						echo "<a style='font-size:20px; float:left; margin-left:0px; text-decoration:none; color:#607AB4;' href='unfollow.php?userid=$id&username=$username'  style='float:right; '>Unfollow</a>";
					}
					else{
						
						echo "<a style='font-size:20px; float:left; margin-left:0px; text-decoration:none; color:#607AB4;' href='follow.php?userid=$id&username=$username'  style='float:right;'>Follow</a>";
					}
	...
	<div style=" width:450px; margin-left:245px; margin-right:0px; background-color:white; padding:20px; width:550px;">			
				<?php
